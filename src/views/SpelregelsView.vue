            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h2 class="fs-6 mb-0 txt-orange fw-bolder">De spelregels</h2>
                    </div>
                </div>
            </div>
        </header>
        <main class="container-md py-2 py-md-5">
            <div class="row g-3">
                    ...
                    <div class="card border-0 rounded-0 shadow-sm mb-3">
                        <div class="card-body p-4">
                            ...
                            <p>Bij vragen waarbij er een <b>team</b> of <b>speler</b> opgegeven moet worden zijn er <b
                                class="txt-orange">10 pnt. </b> te verdienen<sup>1</sup>. Bij inschattingsvragen<sup>2,
                ...
                <div class="col-md-4">
                    <div class="card border-0 rounded-0 shadow-sm">
                        <div class="card-body p-4">
                            <h2 class="mb-b txt-blue fw-bolder">FAQ</h2>
