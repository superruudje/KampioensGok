            ...
            <div class="col-md-8">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <span class="txt-orange fw-bold" style="font-size: 5rem">
                            <number-counter :number="3"></number-counter>
                        </span>
                                <span class="txt-blue fw-bold">Uitslagen goed (10 pnt.)</span>
                                <i class="position-absolute top-0 end-0 bi p-2 bi-question-circle ms-2"
                                   data-bs-title="Uitslag correct voorspeld" data-bs-toggle="tooltip"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card border-0 rounded-0 shadow-sm">
                            <div class="card-body position-relative d-flex flex-column align-items-center p-2 p-md-4">
                        <span class="txt-orange fw-bold" style="font-size: 5rem">
                            <number-counter :number="14"></number-counter>
                        </span>
                                <span class="txt-blue fw-bold">Gelijkspel (7 pnt.)</span>
                                <i class="position-absolute top-0 end-0 bi p-2 bi-question-circle ms-2"
                                   data-bs-title="Gelijkspel correct voorspeld" data-bs-toggle="tooltip"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <span class="txt-orange fw-bold" style="font-size: 5rem">
                            <number-counter :number="14"></number-counter>
                                ...
                                <i class="position-absolute top-0 end-0 bi p-2 bi-question-circle ms-2"
                                   data-bs-title="Aantal teams goed voorspeld in knock-out fase" data-bs-toggle="tooltip"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div class="card border-0 rounded-0 shadow-sm mb-3">
                    <div class="card-body position-relative p-2 p-md-4">
                        <h2 class="txt-blue fw-bolder">Voorspellingen</h2>
                        ...
                        <match-day-prediction v-for="match_day in matches_played" :match_day="match_day" :name="participant.name"
                                              :played="true" class="mb-4"></match-day-prediction>
                        <match-day-prediction v-for="match_day in matches_to_play" :match_day="match_day"
                ...
                <div class="card border-0 rounded-0 shadow-sm">
                    <div class="card-body p-2 p-md-4">
                        ...
                        <div class="d-flex flex-column mb-3" v-for="(q, idx) in bonus">
                            ...
                            <span>{{ getTeamName(participant.bonus[idx]) || '-' }}
