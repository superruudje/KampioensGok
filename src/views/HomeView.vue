            ...
            <div class="col-12 col-md-4">
                <div class="card border-0 rounded-0 shadow-sm mb-3">
                    <div class="card-body p-2 p-md-4">
                        ...
                        <router-link :to="{name: 'ranglijst'}" class="btn btn-sm btn-orange rounded-0 fw-bolder py-2 px-3"
                ...
                <div class="card border-0 rounded-0 shadow-sm">
                    <div class="card-body p-2 p-md-4">
                        ...
                        <div class="matches-wrapper">
                            ...
                            <router-link :to="{name: 'programma'}" class="btn btn-sm btn-orange rounded-0 fw-bolder py-2 px-3"
