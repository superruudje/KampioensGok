        ...
        <header class="bg-26-primary py-3 py-md-5">
            <div class="container-lg">
                <div class="row text-light">
                    <div class="col-12">
                        <h1 class="w26-condensed mb-0">{{ player.team_name }}</h1>
                    </div>
                </div>
            </div>
        </header>
        <main class="container-lg py-3 py-md-5">
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    ]" class="mb-2" @go-to-step="goToStep"/>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <Transition name="slide-fade">
                        ...
                        <form
                            ...
                            <div class="card-body p-3 p-md-4">
                                ...
                                <FormError v-if="wasValidated && !isValid" class="mb-3"/>
                                <ButtonBar is-first @previous="previous" @save="save"/>
                            </div>
                        </form>
                        <form
...
function loadPlayerByToken(token: string) {
    const existingPlayer = tournament.getPlayerByToken(token);
    ...
    Object.assign(
        player.value,
        structuredClone(existingPlayer)
    );
