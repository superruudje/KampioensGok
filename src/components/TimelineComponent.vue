<template>
    <div class="position-relative d-flex flex-column align-items-center gap-3">
        ...
        <div v-for="e in ordered_timeline" class="position-relative z-1 d-flex justify-content-around align-items-center w-100">
            ...
            <div class="mx-3 text-center icon bg-gray">
                <FontAwesomeIcon :icon="e.type === 'goal' ? faSoccerBall : faMobile" :class="{'text-warning' : e.type === 'yellow', 'text-danger' : e.type === 'red'}"/>
            </div>
            <div class="time-line">
